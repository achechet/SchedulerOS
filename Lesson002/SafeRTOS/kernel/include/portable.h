...
KERNEL_FUNCTION void vPortErrorHook( portTaskHandleType xHandleOfTaskWithError, const portCharType *pcErrorString, portBaseType xErrorCode );
KERNEL_FUNCTION void vPortTaskDeleteHook( portTaskHandleType xTaskBeingDeleted );
KERNEL_FUNCTION void vPortTickHook( void );

/* The Idle Hook may be executed in unprivileged mode. */
