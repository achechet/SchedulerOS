 ...
 * defined here simply to allow correctly
...
KERNEL_FUNCTION portBaseType xTimerCreate( const timerInitParametersType * const pxTimerParameters, timerHandleType *pxCreatedTimer );
...
KERNEL_FUNCTION portBaseType xTimerReset( timerHandleType xTimer, portTickType xBlockTime );
...
KERNEL_FUNCTION portBaseType xTimerDelete( timerHandleType xTimer, portTickType xBlockTime );
...
KERNEL_FUNCTION portBaseType xTimerResetFromISR( timerHandleType xTimer, portBaseType *pxHigherPriorityTaskWoken );
...
KERNEL_FUNCTION portBaseType xTimerInitialiseFeature(
    timerInstanceParametersType *pxTimerInstance,
    portUnsignedBaseType uxTimerTaskPriority,
    portUnsignedBaseType uxTimerTaskStackSize,
    portInt8Type *pcTimerTaskStack,
    portUnsignedBaseType uxTimerCmdQueueLength,
    portUnsignedBaseType uxTimerCmdQueueBufferSize,
    portInt8Type *pcTimerCmdQueueBuffer );
