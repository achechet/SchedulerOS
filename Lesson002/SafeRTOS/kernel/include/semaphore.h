...
/* The following macros are part of the semaphore API however they can be
...
KERNEL_FUNCTION portBaseType xSemaphoreCreateBinary( portInt8Type *pcSemaphoreBuffer, xSemaphoreHandle *pxSemaphore );
KERNEL_FUNCTION portBaseType xSemaphoreCreateCounting( portUnsignedBaseType uxMaxCount, portUnsignedBaseType uxInitialCount, portInt8Type *pcSemaphoreBuffer, xSemaphoreHandle *pxSemaphore );
